package com.theoplayer.sample.background.media
...
import com.theoplayer.sample.background.R
...
class MediaNotificationBuilder(
    ...
    private val playAction = NotificationCompat.Action(
        com.theoplayer.sample.common.R.drawable.ic_play, context.getString(R.string.play),
    ...
    private val pauseAction = NotificationCompat.Action(
        com.theoplayer.sample.common.R.drawable.ic_pause, context.getString(R.string.pause),
        MediaButtonReceiver.buildMediaButtonPendingIntent(
            context,
            PlaybackStateCompat.ACTION_PLAY_PAUSE
        )
    ...
    fun build(
        ...
        builder.apply {
            ...
            setSmallIcon(com.theoplayer.sample.common.R.drawable.ic_music_note)
...
fun loadPlaceHolderIcon(context: Context, res: Int = com.theoplayer.sample.common.R.drawable.ic_media_large): Bitmap? {
    return try {

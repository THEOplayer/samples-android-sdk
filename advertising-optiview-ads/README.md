...
A sample demonstrating how to integrate [OptiView Player] (formerly THEOplayer) with OptiView Ads on Android
using [Open Video UI]. You can find more information about the OptiView Ads integration [here](https://optiview.dolby.com/docs/ads/getting-started/android/).

## Quick Start

1. Open this repository in Android Studio.
2. Select the `advertising-optiview-ads` run configuration.

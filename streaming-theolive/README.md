...
A sample demonstrating how to integrate [OptiView Player] (formerly THEOplayer) with THEOlive streaming on Android
using [Open Video UI]. You can find more information about the THEOlive integration [here](https://optiview.dolby.com/docs/theolive/playback/android/getting-started/).
